...
sourceInputfile = 'D:/tmp/cTakesExample/cData'
 
# Destination inputfile path
destinationInputfile = 'D:/temp1/cTakesExample/cData'

# Source resource path
sourceResourcefile = 'D:/cTakes/cTAKES/resources'
 
# Destination resource path
destinationResourcefile = 'D:/temp1/ctakes-config'
...
def create_dir():
    ...
    #  Copy the content of Input source to destination
